...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $consulta_info = $conn->query(" select * from instituto "); //traemos datos de la Instituto desde BD
      $dato_info = $consulta_info->fetch_object();
      $this->Image('logo.jpg', 160, 5, 20); //logo del inatituto,moverDerecha,moverAbajo,tamañoIMG
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE AREAS "), 0, 1, 'C', 0);
      $this->Ln(7);
...
$pdf->Output('Reporte AREAS.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)